...
// expo-secure-store (iOS Keychain) caps values at ~2KB, too small for a
// Supabase session — so only the AES key lives there. The encrypted session
// itself goes in AsyncStorage, which has no size limit. Per Supabase's RN
// auth guide.
